...
class EmbeddedModelFieldSerializer(serializers.JSONField):
    ...
    def to_internal_value(self, data):
        data = super(EmbeddedModelFieldSerializer,
    ...
    def to_representation(self, value):
        ...
        value = super(EmbeddedModelFieldSerializer,
                      self).to_representation(serializer.data)
    ...
    def create(self, validated_data):
        ...
        if many_to_many:
            for field_name, value in many_to_many.items():
                ...
                field.set(value)
        if array_reference:
            for field_name, value in array_reference.items():
                field = getattr(instance, field_name)
                field.add(*value)
        return instance
