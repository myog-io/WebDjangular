# Generated by Django 2.1.4 on 2018-12-22 19:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='', to='webdjango.Address')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('ckeditor', 'CkEditor'), ('button', 'Button'), ('text', 'Text'), ('codeEditor', 'CodeEditor'), ('select', 'Select')], default='text', max_length=32)),
