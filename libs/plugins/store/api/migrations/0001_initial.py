# Generated by Django 2.1.4 on 2018-12-22 04:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conditions', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('translation', django.contrib.postgres.fields.jsonb.JSONField(default=None, null=True)),
                ...
                ('variant_attributes', django.contrib.postgres.fields.hstore.HStoreField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('ckeditor', 'CkEditor'), ('button', 'Button'), ('codeEditor', 'CodeEditor'), ('text', 'Text'), ('select', 'Select')], default='text', max_length=32)),
                ('is_variant', models.BooleanField(default=False)),
                ('options', django.contrib.postgres.fields.hstore.HStoreField(blank=True, null=True)),
            ],
            options={
                'ordering': ['-created'],
            },
