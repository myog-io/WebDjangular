...
import { ThemeIspwebbyModalChoosecityComponent } from '../../modal/choosecity/choosecity.component';
...
@Component({
  selector: 'theme-ispwebby-top-header',
  templateUrl: './top-header.component.html',
  styleUrls: ['./top-header.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ThemeIspwebbyTopHeaderComponent implements AfterViewInit, OnDestroy {
  testBrowser: boolean;
  city_name: string;
  plan_type: string;
  ...
  constructor(
    ...
    this.cookieSub = this.clientUserService.clientCookieChange.subscribe((cookie) => {
  ...
  openModalChooseCity() {
    if (this.testBrowser) {
      this.modalService.open(ThemeIspwebbyModalChoosecityComponent, {
        centered: true,
